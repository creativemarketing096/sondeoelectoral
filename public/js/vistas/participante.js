...
export function iniciar(distrito) {
  ...
  async function verificarCedula() {
    ...
    try {
      ...
      if (r.estado === "ip_bloqueada") { $("#ciEstado").className = "aviso malo"; $("#ciEstado").textContent = "No se puede participar desde esta conexión."; return; }
